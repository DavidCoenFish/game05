...
public:
    ...
    const VectorInt2 GetParentWindowAttach(const VectorInt2& in_parent_window_size, const VectorInt2& in_parent_offset) const;
...
private:
    ...
    VectorFloat2 _layout_pivot_ratio;
    /// The pivot on the parent layout that the layout element is attached to
    VectorFloat2 _parent_window_attach_ratio;
