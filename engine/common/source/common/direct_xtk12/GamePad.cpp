...
#include "CommonPCH.h"
#include "Common/DirectXTK12/GamePad.h"
...
private:
    ...
    std::unique_ptr<void, handle_closer> mChanged;
...
void GamePadButtonStateTracker::Update(const GamePad::State& state) noexcept
{
...
{
    memset(this, 0, sizeof(GamePadButtonStateTracker));
}
