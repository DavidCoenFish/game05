...
void LocaleStringFormatSimple::AccumulateToken(const LocaleSystem& in_locale_system, const LocaleISO_639_1 in_locale, const std::string& in_token, const int in_index)
{
	in_locale_system;
	in_locale;
	in_token;
