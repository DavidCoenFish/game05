...
namespace DirectX
{
    ...
    private:
      ...
      public:
         ...
         GamePadButtonStateTracker() noexcept { Reset(); }

         void __cdecl Update(const GamePad::State& state) noexcept;

         void __cdecl Reset() noexcept;

         GamePad::State __cdecl GetLastState() const noexcept { return lastState; }
