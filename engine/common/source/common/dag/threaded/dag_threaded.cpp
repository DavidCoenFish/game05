...
namespace
{
    ...
    {
    public:
        NodeVisitor(const int32_t in_index, LocaleSystem& in_locale_system, DagThreadedCollection& in_collection) 
        : _index(in_index)
    ...
    private:
        DagThreadedCollection& _collection;
    ...
    public:
        TooltipBuilder(
            DagThreadedCollection& in_collection,
...
const std::string DagThreaded::GetTooltipText(DagThreadedCollection& in_collection, const NodeID in_node_id, LocaleSystem& in_locale_system)
{
    in_collection;
    std::string value;
...
const std::shared_ptr<Tooltip> DagThreaded::GetTooltipBody(DagThreadedCollection& in_collection, const NodeID in_node_id, LocaleSystem& in_locale_system)
{
