...
// Solution. Have the windows include in a common file, common/common.h
...
// but the internal use in code is still via a "static_rts" path and a "StaticRts" namespace
namespace StaticRts
{
}
